...
abstract: >
  ...
  Firstly, a precise evaluation of the computational time and memory requirements for geo-localised data is carried out using the dbmss package in R (@dbmss) by means of performance tests. 
...
In the *dbmss* package [@dbmss], the function applies to a set of points, object of class `wmppp`, or to a matrix of distances, object of class `Dtable`.
...
The memory used is evaluated with the *profmem* package [@Bengtsson2020].
