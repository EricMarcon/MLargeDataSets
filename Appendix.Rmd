...
In the *dbmss* package, the function applies to a set of points, object of class `wmppp`, or to a matrix of distances, object of class `Dtable`.
...
The correlation between the $M$ values estimated by each method is calculated at each distance.
...
The correlation between the $M$ values calculated by each method is calculated at each distance.
