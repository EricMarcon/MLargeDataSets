...
To sum up, general conclusions can be drawn.
...
Computing time is thus the most general issue.
The computing time of the *K~d~* function is similar to that of *M* while the *D* function is far slower: topographic DBMs require correcting edge effects [@Marcon2017], which rely on complex calculation.
