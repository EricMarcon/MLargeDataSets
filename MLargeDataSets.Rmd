...
In this article, we only consider the intra-type version of *M*: we study the spatial structure of neighbouring points of the same type (called *points of interest*) as the points at the centres of the disks of radius $r$.
...
-   $x^s_j$, the location of a neighbour $j$ of the same type as point $i$,
-   $x_j$, the location of a neighbour $j$ of $i$, whatever its type,
-   $w(.)$, the weight of a given neighbour. In that sense, $w(x_j)$ defines the weight of a neighbour $j$ of $i$.
...
The Euclidean distance is generally preferred for the calculation of *M* but the *dbmss* package can also be used for network distances.
