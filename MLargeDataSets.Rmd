...
For a set of five million points, the expected calculation time is $5 \times 50^{1.6} \approx 2,600$ seconds, nearly 3/4 of an hour.
1,000 simulations would then take around one month.
