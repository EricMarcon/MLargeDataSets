...
Because spatial concentration offers productivity gains due to cost reductions, economists and geographers in regional science have extensively studied clusters of economic activity, their consequences on territories and the importance of the determinants that explain them since @Marshall1890.
...
Empirical studies at highly detailed geographical levels have been proposed in recent years [see among others worlks of @Daspremont2025 or @Baragwanath2026 based on satellite imagery].
...
By considering space as continuous, the advantage of these distance-based methods is to circumvent any statistical bias associated to a discretisation of space into separate units (known as the MAUP-Modifiable Areal Unit Problem, see @Openshaw1979 or @Arbia1989).
...
This result contributes to very precise developments that explain such agglomeration patterns.
...
Various applications of *M* have been proposed.
For example, @Jensen2011 and @Floch2018 analyze the spatial concentration different facilities in French cities while @Coll-Martinez2019 proposed an application of the *M* function on creative industries at a larger spatial scale, that is in a Spanish metropolitan area.
...
We studied the effect of the geographical approximation of the locations of the analyzed entities.
...
The first two sections present the *M* function and the necessary data generated for the tests.
